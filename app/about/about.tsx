...
const AboutUs = () => {
  return (
    <div className=" flex justify-center w-screen pt-24 dark:bg-slate-950 text-black dark:text-white">
          ...
          <div className=" flex flex-col">
            <div className=" flex flex-row gap-10 py-10">
              <div className=" flex flex-row gap-10 min-w-[300px] ">
                <h1 className=" text-lg text-blue-400 ">Jan 2024 - present</h1>
              </div>
              <div className=" flex flex-col gap-1">
                <h1 className=" text-lg text-blue-400 ">
                  Junior React Developer
                </h1>
                <p className=" text-sm font-semibold ">Credixo</p>
